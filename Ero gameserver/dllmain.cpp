...
DWORD InitThread(LPVOID)
{
    ...
    LPVOID QuickChatMessageAddr = (LPVOID)(BaseAddr + 0x197f6d0);
    ...
    MH_CreateHook(QuickChatMessageAddr, ServerPlaySquadQuickChatMessage , nullptr);
    MH_EnableHook(QuickChatMessageAddr);
